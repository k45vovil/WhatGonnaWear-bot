...
def get_weather(city):
    ...
    try:
        ...
        res = f'{advice}\n\n📍Погода у - м. <b>{city}</b> в {time}:00\n{description}. 🌡<i>Температура повітря:</i> <b>{temp}°C</b>, <i>відчувається як:</i> <b>{feels_like}°C</b>. 💧<i>Вологість:</i> {humidity} %, 🌬<i>швидкість вітру</i> {wind_speed} м/с.'
        ...
        res2 = f'📍Погода у - м. <b>{city}</b> в {time2}:00\n{description2}. 🌡<i>Температура повітря:</i> <b>{temp2}°C</b>, <i>відчувається як:</i> <b>{feels_like2}°C</b>. 💧<i>Вологість:</i> {humidity2} %, 🌬<i>швидкість вітру</i> {wind_speed2} м/с.'
        ...
        res3 = f'📍Погода у - м. <b>{city}</b> в {time3}:00\n{description3}. 🌡<i>Температура повітря:</i> <b>{temp3}°C</b>, <i>відчувається як:</i> <b>{feels_like3}°C</b>. 💧<i>Вологість:</i> {humidity3} %, 🌬<i>швидкість вітру</i> {wind_speed3} м/с.'
